...
CREATE TABLE `dbmaintenancerequests` (
  `id` varchar(256) NOT NULL,
...
--
-- Dumping data for table `dbmaintenancerequests`
--
...
('', 'N/A', 'vmsroot', '', '', 'N/A', 'VA', '', '', 'N/A', '', '', 'N/A', 'vmsroot', '', 'n/a', '', NULL, '', 'N/A', NULL, '$2y$10$YfMFlBn/BddtIeIJhNEXtuqroTQBcarORGXFFIsPkbSelKI0lgTqq', '', '', 0, '', 0, 0, 0.00, 0, NULL, ''),
...
('testadmin', '2025-10-19', 'Test', 'Admin', '123 Test Street', 'Test City', 'VA', '12345', '5551234567', 'cellphone', '5559876543', 'cellphone', '1990-01-01', 'testadmin@micahministries.org', 'Test', 'n/a', 'Friend', NULL, 'admin', 'Active', NULL, '$2y$10$akU75N0tznG2kBt0JGWu/O.kUlIkuAAvsZL3MamYvwly75wRhCxg.', '', '', 0, 'Contact', 0, 0, 0.00, 0, NULL, 'None'),
('testcasemanager', '2025-10-19', 'Test', 'Case Manager', '123 Test Street', 'Test City', 'VA', '12345', '5551234567', 'cellphone', '5559876543', 'cellphone', '1990-01-01', 'testcasemanager@micahministries.org', 'Test', 'n/a', 'Friend', NULL, 'case_manager', 'Active', NULL, '$2y$10$yJ6pkGmtdgA4LZLat0wvqejIjBh7mlKKOaj/k14H5iDbcsc6eighu', '', '', 0, 'Contact', 0, 0, 0.00, 0, NULL, 'None'),
('testmaintenance', '2025-10-19', 'Test', 'Maintenance', '123 Test Street', 'Test City', 'VA', '12345', '5551234567', 'cellphone', '5559876543', 'cellphone', '1990-01-01', 'testmaintenance@micahministries.org', 'Test', 'n/a', 'Friend', NULL, 'maintenance', 'Active', NULL, '$2y$10$Q7ld1zMGZ8YP/ItMwB9GQe8v.iN.Kqr2MoDd4Gv1yFKRP0m2EskDq', '', '', 0, 'Contact', 0, 0, 0.00, 0, NULL, 'None'),
...
--
-- Indexes for table `dbmaintenancerequests`
--
ALTER TABLE `dbmaintenancerequests`
  ADD PRIMARY KEY (`id`);
